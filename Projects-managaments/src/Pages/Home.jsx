...
function Home() {
  return (
    ...
    <main class="text-gray-900">
            ...
            <div class="container mx-auto px-8 lg:flex">
                <div class="text-center lg:text-left lg:w-1/2">
                    ...
                    <p class="mt-8 md:mt-12">
                        <button type="button"
                            class=" py-4 px-12 bg-[#1B4242] hover:bg-[#5C8374] rounded-md text-white">Get Started</button>
                    </p>
                ...
                <div class="lg:w-1/2">
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink"
                        ...
                        <path
                            ...
                            fill="#3f3d56"></path>
                        <path fill="#5C8374" d="M768.43 719.66l11.19-7.04 120.8-1.04 3.11 8.08h-135.1z"></path>
                        ...
                        <path
                            ...
                            fill="#5C8374"></path>
                        <path d="M231.65 621.73L208 627.1l-5.37-23.64a22.57 22.57 0 1029 18.27z" fill="#5C8374">
                        </path>
                        <path
        ...
        <h3 class="text-3xl font-semibold leading-tight mt-52 text-center">Features</h3>
        <div className='flex justify-center flex-wrap mt-20 lg:gap-16 md:gap-10 max-sm:gap-10'>
    ...
    <div
        ...
        <div class="relative z-10 mx-auto max-w-md">
            <span class="grid h-20 w-20 place-items-center rounded-full bg-[#5C8374] transition-all duration-300 group-hover:bg-[#9EC8B9]">
                ...
                <img 
                src="https://cdn-icons-png.flaticon.com/128/7860/7860248.png" 
                className='h-12 w-12 transition-all'
                alt="" />
            </span>
            <div
                class="space-y-6 pt-5 text-base leading-7 text-gray-600 transition-all duration-300 group-hover:text-white/90">
                <p>Facilitating the process of selecting graduation project ideas for students.</p>
            </div>
...
<div class="relative flex flex-col justify-center overflow-hidden py-6 sm:py-12 ">
    <div
        ...
        <div class="relative z-10 mx-auto max-w-md">
            <span class="grid h-20 w-20 place-items-center rounded-full bg-[#5C8374] transition-all duration-300 group-hover:bg-[#9EC8B9]">
            <img 
                src="https://cdn-icons-png.flaticon.com/128/3094/3094751.png" 
                className='h-12 w-12 transition-all'
                alt="" />
            </span>
            <div
                class="space-y-6 pt-5 text-base leading-7 text-gray-600 transition-all duration-300 group-hover:text-white/90">
                <p>Waiting time for approval is faster.</p>
            </div>
            <div class="pt-5 text-base font-semibold leading-7">
...
<div class="relative flex flex-col justify-center overflow-hidden py-6 sm:py-12">
    <div
        ...
        <div class="relative z-10 mx-auto max-w-md">
            <span class="grid h-20 w-20 place-items-center rounded-full bg-[#5C8374] transition-all duration-300 group-hover:bg-[#9EC8B9]">
            <img 
                src="https://cdn-icons-png.flaticon.com/128/1162/1162302.png" 
                className='h-12 w-12 transition-all'
                alt="" />
            </span>
            <div
                class="space-y-6 pt-5 text-base leading-7 text-gray-600 transition-all duration-300 group-hover:text-white/90">
                <p>Students can present previously implemented ideas.</p>
            </div>
            <div class="pt-5 text-base font-semibold leading-7">
            ...
            <div class="container mx-auto px-16 items-center flex flex-col lg:flex-row">
                ...
                <div class="mt-10 lg:mt-0 w-full lg:w-1/2 undefined">
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1113.58 784.41">
                        ...
                        <ellipse cx="965" cy="767.42" rx="64" ry="16.99" fill="#5C8374" opacity=".1"></ellipse>
                        <path
                        ...
                        <ellipse cx="193.5" cy="750.89" rx="57.01" ry="10.96" fill="#5C8374">
                        </ellipse>
                        ...
                        <circle cx="318" cy="385.41" r="28" fill="#5C8374"></circle>
                        <circle cx="448" cy="240.41" r="28" fill="#5C8374"></circle>
                        <circle cx="578" cy="313.41" r="28" fill="#5C8374"></circle>
                        <circle cx="708" cy="89.41" r="28" fill="#5C8374"></circle>
                        <circle cx="958" cy="327.41" r="28" fill="#5C8374"></circle>
                        <ellipse cx="233.68" cy="722.61" rx="18.68" ry="3.16" fill="#5C8374" opacity=".1">
                        </ellipse>
                        <path
                        ...
                        <path
                            ...
                            opacity=".2"></path>
                        <ellipse cx="1063.8" cy="749.41" rx="34.31" ry="5.8" fill="#5C8374" opacity=".1">
                        </ellipse>
                        <path
